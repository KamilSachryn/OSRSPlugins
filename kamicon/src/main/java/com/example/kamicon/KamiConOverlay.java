...
@Slf4j
@Singleton
class KamiConOverlay extends OverlayPanel
{
    private final Client client;
    private final KamiConPlugin plugin;
    private final KamiConPluginConfig config;

    String timeFormat;
    private String infoStatus = "Starting...";

    @Inject
    private KamiConOverlay(final Client client, final KamiConPlugin plugin, final KamiConPluginConfig config)
    {
        super(plugin);
        ...
        this.plugin = plugin;
        this.config = config;
        getMenuEntries().add(new OverlayMenuEntry(RUNELITE_OVERLAY_CONFIG, OPTION_CONFIGURE, "KamiCon overlay"));
    }
