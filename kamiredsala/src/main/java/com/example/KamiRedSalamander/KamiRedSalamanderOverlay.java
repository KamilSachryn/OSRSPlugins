...
@Slf4j
@Singleton
class KamiRedSalamanderOverlay extends OverlayPanel
{
    private final Client client;
    private final KamiRedSalamanderPlugin plugin;
    private final KamiRedSalamanderPluginConfig config;

    String timeFormat;
    private String infoStatus = "Starting...";

    @Inject
    private KamiRedSalamanderOverlay(final Client client, final KamiRedSalamanderPlugin plugin, final KamiRedSalamanderPluginConfig config)
    {
        super(plugin);
        ...
        this.plugin = plugin;
        this.config = config;
        getMenuEntries().add(new OverlayMenuEntry(RUNELITE_OVERLAY_CONFIG, OPTION_CONFIGURE, "KamiRedSalamander overlay"));
    }
