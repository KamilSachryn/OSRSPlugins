...
@Slf4j
@Singleton
class KamiWinterOverlay extends OverlayPanel
{
    private final Client client;
    private final KamiWinterPlugin plugin;
    private final KamiWinterPluginConfig config;

    String timeFormat;
    private String infoStatus = "Starting...";

    @Inject
    private KamiWinterOverlay(final Client client, final KamiWinterPlugin plugin, final KamiWinterPluginConfig config)
    {
        super(plugin);
        ...
        this.plugin = plugin;
        this.config = config;
        getMenuEntries().add(new OverlayMenuEntry(RUNELITE_OVERLAY_CONFIG, OPTION_CONFIGURE, "KamiWinter overlay"));
    }
