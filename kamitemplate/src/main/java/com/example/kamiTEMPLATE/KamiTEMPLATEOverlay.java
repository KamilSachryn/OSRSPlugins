...
@Slf4j
@Singleton
class KamiTEMPLATEOverlay extends OverlayPanel
{
    private final Client client;
    private final KamiTEMPLATEPlugin plugin;
    private final KamiTEMPLATEPluginConfig config;

    String timeFormat;
    private String infoStatus = "Starting...";

    @Inject
    private KamiTEMPLATEOverlay(final Client client, final KamiTEMPLATEPlugin plugin, final KamiTEMPLATEPluginConfig config)
    {
        super(plugin);
        ...
        this.plugin = plugin;
        this.config = config;
        getMenuEntries().add(new OverlayMenuEntry(RUNELITE_OVERLAY_CONFIG, OPTION_CONFIGURE, "KamiTEMPLATE overlay"));
    }
